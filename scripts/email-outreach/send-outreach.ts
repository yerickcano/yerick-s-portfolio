...
function buildHtml(hotel: HotelRow): string {
  ...
  const cta = hasWebsite
    ? `<p>Pueden ver mi trabajo en: <a href="https://www.yerick.me" style="color:#c00;">www.yerick.me</a></p>`
    : `<p>Le comparto un ejemplo de lo que podríamos hacer: <a href="https://tourism-online.vercel.app" style="color:#c00;">tourism-online.vercel.app</a></p>`;

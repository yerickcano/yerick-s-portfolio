    ...
    <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <a 
              ...
              className="flex items-start p-4 bg-surface border border-theme rounded-lg hover:bg-primary hover:border-primary-hover transition-all duration-200 group cursor-pointer"
            >
            ...
            <a 
              ...
              className="flex items-start p-4 bg-surface border border-theme rounded-lg hover:bg-blue-600 hover:border-blue-700 transition-all duration-200 group cursor-pointer"
            >
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-start p-4 bg-surface border border-theme rounded-lg hover:bg-gray-800 hover:border-gray-700 transition-all duration-200 group cursor-pointer"
            >
        ...
        <div>
          ...
          <div className="bg-surface border border-theme p-6 rounded-lg mb-6">

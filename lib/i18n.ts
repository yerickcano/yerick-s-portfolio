...
export const t = {
  ...
  es: {
    ...
    packages: {
      ...
      addons: [
        { name: "Mantenimiento mensual", desc: "Actualizaciones, hosting, soporte", price: "₡40mil–₡100mil/mes" },
        { name: "Upgrade a chatbot con IA", desc: "Respuestas con Claude API", price: "+₡300mil–₡600mil" },
        { name: "Auditoría de código y UX", desc: "Para productos existentes", price: "₡150mil–₡600mil" },
        { name: "Automatización adicional", desc: "Por flujo agregado", price: "+₡100mil–₡300mil" },
        { name: "Consultoría de arquitectura", desc: "Doc de stack + schema, sin construcción", price: "₡400mil–₡1,250,000" },
        { name: "Integración Sinpe Móvil", desc: "Flujo de pagos local CR", price: "+₡200mil–₡400mil" },
      ],
    },
    footer: {

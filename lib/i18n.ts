...
export const t = {
  ...
  es: {
    ...
    packages: {
      ...
      addons: [
        { name: "Mantenimiento mensual", desc: "Actualizaciones, hosting, soporte", price: "₡40,000–₡100,000/mes" },
        { name: "Upgrade a chatbot con IA", desc: "Respuestas con Claude API", price: "+₡300,000–₡600,000" },
        { name: "Auditoría de código y UX", desc: "Para productos existentes", price: "₡150,000–₡600,000" },
        { name: "Automatización adicional", desc: "Por flujo agregado", price: "+₡100,000–₡300,000" },
        { name: "Consultoría de arquitectura", desc: "Doc de stack + schema, sin construcción", price: "₡400,000–₡1,250,000" },
        { name: "Integración Sinpe Móvil", desc: "Flujo de pagos local CR", price: "+₡200,000–₡400,000" },
      ],
    },
    footer: {
